...
const HeaderCurse = () => {
  return (
    ...
    <div className="flex flex-row ml-[11.5rem] mr-[11.5rem] bg-[url(https://blog.cronapp.io/wp-content/uploads/2020/09/javascript-1.jpg)] ">
      <div className="flex flex-col m-4 text-white">
        <h1 className="text-3xl m-4 backdrop-blur-sm">JavaScript Avansado - qweqwe qweqwe</h1>
