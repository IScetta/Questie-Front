...
const SideBar: React.FC<{ course: ICourse }> = ({
  course,
}: {
  course: ICourse;
}): JSX.Element => {
  ...
  let numberModule = 1;
  return (
    <div className="bg-purpleMain py-3 fixed top-0 left-0 right-0 shadow-md z-99 z-50 sm:hidden">
      <div>
      ...
      <div
        className={`${
          open ? "w-80" : "w-0"
        } bg-purpleMainLight min-h-screen fixed top-0 left-0 transition-all duration-300 z-20 h-full`}
      >
